      ...
      <Modal visible={!!datePickerTarget} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            />
            <Button onPress={() => setDatePickerTarget(null)}>{t('common.cancel')}</Button>
          </View>
        </View>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  modalContent: { backgroundColor: '#FFFFFF', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 16 },
