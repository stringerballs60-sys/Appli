    ...
    <div>
      ...
      <div className="px-5 py-4 flex items-center justify-between" style={{ backgroundColor: '#1A365D' }}>
        <div>
          ...
          <p className="text-sm mt-0.5 capitalize" style={{ color: 'rgba(255,255,255,0.70)' }}>
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <KpiCard
            ...
            icon={<Home className="w-5 h-5" style={{ color: '#1A365D' }} />}
            color="navy"
            href="/properties"
          />
          <KpiCard
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            <SectionHeader title="Activité du jour" />
          ...
          <div className="space-y-4">
            <SectionHeader title="Alertes & actions" />
...
function KpiCard({
  ...
  return (
    <Link href={href}>
      <Card
        className={`border hover:shadow-md transition-shadow cursor-pointer ${colorMap[color] || colorMap.gray}`}
        style={color === 'navy' ? { backgroundColor: '#E2E8F0' } : {}}
      >
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        {type === 'upcoming' && (
          <span className="text-xs font-medium" style={{ color: '#1A365D' }}>
