  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-0.5">Gestion du compte</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-kaza-blue flex items-center justify-center text-white font-bold text-lg">
